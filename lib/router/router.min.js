var router=function(){const parent=this;this.notfound=!0;this.routes=[];this.paramsEnabled=!1;this.routeCall=function(){};this.params=[];this.BeforeRouteMiddleware='*';this.BeforeRouteMiddlewareFunc=null;this.AfterRouteCallback=null;this.route={};let notFoundCallback=function(){throw new TypeError('Router.js : 404 error.')};this.setErrorCallback=function(func){notFoundCallback=func};this.getCurrentURI=function(){return new RouterRequest().getURI()};this.before=function(route,func){parent.BeforeRouteMiddleware=route;parent.BeforeRouteMiddlewareFunc=func};this.add=function(name,route,callback){let routeArray=route.split('/');let paramsEnabled=!1;let params=[];routeArray.forEach(function(e){if(e.substr(0,1)===':'){paramsEnabled=parent.paramsEnabled=!0;params.push(e.substr(1,e.length))}});switch(route.substr(0,2)){case '#/':route=route.substr(1);break;case '/#':route=route.substr(2);break}
    ...
    if(this.callback!=null){if(this.route==='*'){this.callback.apply()}else if(this.route===this.URI){this.callback.apply()}}};let handlingParams=function(route){const parent=this;let URIarray=router.getCurrentURI().split('/');let RouteArray=route.split('/');let params=[];this.pushParam=function(param){if(param!==''){params.push(param)}};for(i=0;i<RouteArray.length;i++){if(RouteArray[i].substr(0,1)===':'){parent.pushParam(URIarray[i]);RouteArray[i]=URIarray[i]}}
    RouteOptions={params:params,RouteArray:RouteArray.join('')};return RouteOptions};let Exception=function(message){throw new TypeError(message)}